...
cat /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/WSO-L1.pileup | python /N/slate/danschw/coevo-seedbank-seq/code/python/create_timecourse.py WSO-L1 1 4 7 10 14 > /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/WSO-L1_timecourse.txt
