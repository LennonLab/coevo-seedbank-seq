...
cat /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/SNO-L2.pileup | python /N/slate/danschw/coevo-seedbank-seq/code/python/create_timecourse.py SNO-L2 1 4 7 10 14 > /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/SNO-L2_timecourse.txt
