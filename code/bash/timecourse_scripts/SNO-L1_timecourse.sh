...
cat /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/SNO-L1.pileup | python /N/slate/danschw/coevo-seedbank-seq/code/python/create_timecourse.py SNO-L1 10 14 1 4 7 > /N/slate/danschw/coevo-seedbank-seq/data/timecourses/phage/timecourse_merged/SNO-L1_timecourse.txt
